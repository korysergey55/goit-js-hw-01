...
if (buy === null) {
    ...
    else if (buy === true || credits > pricePerDroid * buy) {
        buy = Number.parseInt(buy)
        total = (credits - (buy * pricePerDroid))
    alert(`Вы купили ${buy} дроидов, на счету осталось ${total} кредитов.`)
    }
        else  {
